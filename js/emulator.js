	...
	this.math = function(x, y, op) {
		...
		switch(op) {
			...
			case 0xE:
				...
				break;
			default:
				haltBreakpoint("unknown math opcode "+op.toString(16));
		}
	}
	...
	this.misc = function(x, rest) {
		...
		switch(rest) {
			...
			case 0x85:
				...
				break;
			default:
				haltBreakpoint("unknown misc opcode "+rest.toString(16));
		}
	}
	...
	this.opcode = function() {
		...
		if (o == 0x5 && n != 0) {
			if (n == 2) {
				...
				haltBreakpoint("unknown opcode "+op.toString(16));
			}
		}
		if (o == 0x9 && n != 0) {
			haltBreakpoint("unknown opcode "+op.toString(16));
		...
		switch(o) {
			...
			default: haltBreakpoint("unknown opcode "+o.toString(16));
		}
	}
